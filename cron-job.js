...
//   axios
//     .get("https://www.ghosthouse.space/data-lotto/get-lotto.php", {
//       params: {
//         date: dateNow,
//       },
//       headers: {
...
//         var sql =
//           "SELECT * FROM lotto_type WHERE open = 0 AND active = 1 ORDER BY updated_at DESC LIMIT 3";
//         connection.query(sql, (error, result, fields) => {
//
//           // var dd = moment.locale("th");
//           var dateTh = moment(new Date()).locale("th").format("dddd");
//           var christianYear = moment(new Date()).format("YYYY");
//           var buddhishYear = (parseInt(christianYear) + 543).toString();
//           var subBuddhishYear = buddhishYear.substring(2, 4);
//           var dateMonth = moment(new Date()).locale("th").format("DD/MM/");
//           var dateThai = `วัน${dateTh} ${dateMonth}${subBuddhishYear}`;
//           // console.log(`วัน${dateTh} ${dateMonth}${subBuddhishYear}`);
//           result.forEach((rs) => {
//             var date = moment(new Date(rs.closing_time)).format("YYYY-MM-DD");
//             response.data.info.forEach((el) => {
//               if (
//                 el.productNameTh.substr(0, 4) == "หุ้น" ||
//                 (el.productNameTh.substr(0, 3) == "หวย" &&
//                   el.productCode != "YK5" &&
//                   el.productCode != "YK")
//               ) {
//                 // console.log(el.productNameTh.substr(0, 3));
//                 // console.log(el.periodName + "==" + dateThai);
//                 if (
//                   rs.lotto_type_name ==
//                     el.productNameTh.substr(4).replace(/\s/g, "") ||
//                   rs.lotto_type_name ==
//                     el.productNameTh.substr(3).replace(/\s/g, "")
//                 ) {
//                   // console.log(el.productNameTh);
//                   var sql =
//                     "SELECT * FROM prize WHERE lotto_type_id = ? AND prize_time = ?";
//                   connection.query(
//                     sql,
//                     [rs.lotto_type_id, date],
//                     (error, resultPrize, fields) => {
//
//                       if (resultPrize == "") {
//                         if (el.award1 != "xxx" && el.award2 != "xx") {
//                           var award3top = el.award1;
//                           var type3top = "3 ตัวบน";
//                           var type2bottom = "2 ตัวล่าง";
//                           if (el.award1.length > 3) {
//                             award3top = el.award1.substr(3, 6);
...
//                           el.award2
//                         );
//                         // console.log(el.award1.substr(3, 6));
//                         // console.log(item.lotto_type_name);
//                       } else {
//                         if (resultPrize[0].status == 0) {
//                           var sql =
...
//                               var sqlUpdate = `UPDATE lotto_number SET status = 'suc' WHERE lotto_number_id = ? AND status_poy = 'SUC' AND status = 'wait'`;
//                               resultLotto.forEach((item) => {
//                                 if (item.type_option === "วิ่งบน") {
//                                   const number = resultPrize.find((n) =>
//                                     n.prize3top.toString().includes(item.number)
//                                   );
//                                   if (
//                                     number != undefined &&
//                                     el.periodName == dateThai
//                                   ) {
//                                     connection.query(
//                                       sqlUpdate,
//                                       [item.lotto_number_id],
...
//                                     );
//                                   }
//                                 } else if (item.type_option === "วิ่งล่าง") {
//                                   const number = resultPrize.find((n) =>
//                                     n.prize2bottom
//                                       .toString()
//                                       .includes(item.number)
...
//                                     );
//                                   }
//                                 } else if (item.type_option === "2 ตัวบน") {
//                                   const number = resultPrize.find((n) =>
//                                     n.prize3top
//                                       .toString()
//                                       .substr(1)
...
//                                     );
//                                   }
//                                 } else if (item.type_option === "3 ตัวโต๊ด") {
//                                   const result = func3back(
//                                     resultPrize[0].prize3top
//                                   );
//                                   if (
//                                     result.indexOf(item.number) != -1 &&
//                                     el.periodName == dateThai
//                                   ) {
//                                     // console.log(item.number, "ถูก 3 ตัวโต๊ด");
//                                     connection.query(
...
//                                     // console.log(item.number, "ไม่ถูก 3 ตัว");
//                                   }
//                                 } else if (item.type_option === "3 ตัวบน") {
//                                   if (
//                                     parseInt(item.number) ===
//                                       parseInt(resultPrize[0].prize3top) &&
//                                     el.periodName == dateThai
...
//                                     );
//                                   }
//                                 } else if (item.type_option === "2 ตัวล่าง") {
//                                   if (
//                                     item.number ===
//                                       resultPrize[0].prize2bottom &&
//                                     el.periodName == dateThai
//                                   ) {
//                                     connection.query(
//                                       sqlUpdate,
...
//                                   //   msg: "อัพเดทออกผลหวยสำเร็จ",
//                                   // });
//                                   var sql = `SELECT SUM(total) as total, created_by FROM prize_log WHERE lotto_date = ? GROUP BY created_by`;
//                                   connection.query(
//                                     sql,
//                                     [date],
//                                     (error, resultPrizeLog, fields) => {
...
//                           );
//                         }
//                         // console.log(rs.lotto_type_name, "ออกผลแล้ว");
//                       }
//                     }
//                   );
//                   // console.log(item.lotto_type_name);
